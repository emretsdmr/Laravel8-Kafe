                            ...
                            <div class="owl-carousel owl-theme">
                                ...
                                <div class="item">
                                    <div class="product_blog_img">
                                        <img src="{{ asset('assets')}}/images/rs1.png" alt="#" />
                                    </div>
                                ...
                                <div class="item">
                                    <div class="product_blog_img">
                                        <img src="{{ asset('assets')}}/images/rs2.png" alt="#" />
                                    </div>
                                    <div class="product_blog_cont">
                                        <h3>Noodles</h3>
                                ...
                                <div class="item">
                                    <div class="product_blog_img">
                                        <img src="{{ asset('assets')}}/images/rs3.png" alt="#" />
                                    </div>
                                    <div class="product_blog_cont">
                                        <h3>Egg</h3>
                                ...
                                <div class="item">
                                    <div class="product_blog_img">
                                        <img src="{{ asset('assets')}}/images/rs4.png" alt="#" />
                                    </div>
                                    <div class="product_blog_cont">
                                        <h3>Sushi Dizzy</h3>
                                ...
                                <div class="item">
                                    <div class="product_blog_img">
                                        <img src="{{ asset('assets')}}/images/rs5.png" alt="#" />
                                    </div>
                                    <div class="product_blog_cont">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-10 col-sm-12 about_img_boxpdnt">
                        <div class="about_img">
                            <figure><img src="{{ asset('assets')}}/images/about-img.jpg" alt="#/"></figure>
                        </div>
                    </div>
                </div>
            </div>
